...
import com.jcosta.xmoney.api.activity.control.ActivityRepository;
...
import com.jcosta.xmoney.api.person.control.PersonRepository;
...
public class ActivityManager {
    ...
    public Page<ActivitySummary> searchSummary(ActivityFilter activityFilter, Pageable pageable) {
        return this.repository.searchSummary(activityFilter, pageable);
    }
}